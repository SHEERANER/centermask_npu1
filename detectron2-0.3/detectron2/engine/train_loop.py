...
class SimpleTrainer(TrainerBase):
    ...
    def __init__(self, model, data_loader, optimizer):
        ...
        """"/home/zsclzy/detectron2-0.3/detectron2/engine/train_loop.py"
        super().__init__()
    ...
    def run_step(self):
       ...
       # pdb.set_trace()
        ...
        #12.13  lzy add retain_graph=True
        #12.14  zsc cancel the process of turning loss to cpu, and edit the roi_alien.py
        #losses=losses.cpu()
        losses.backward()
        #12.15  lzy add two print
        print("losses:",losses)
    ...
    def _write_metrics(self, loss_dict: Dict[str, torch.Tensor], data_time: float):
        ...
        # zsc 12.16 edit to npu
        # Use a new stream so these ops don't wait for DDP or backward
        with torch.npu.stream(torch.npu.Stream() if device.type == "npu" else None):
